...
{
    public class StaffEditorBookDetailsDTO
    {
        public string STF_EDITOR_BOOK_ID { get; set; }
        public string EDITER_STAFF_ID { get; set; }
        public string EDITING_START_DATE { get; set; }
        public string EDITING_END_DATE { get; set; }
        public string EDITING_STATUS { get; set; }
