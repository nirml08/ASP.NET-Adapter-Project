...
{
    public class MentorRegularVisitDetails
    {
        public string MENTORS_REGULAR_VISIT_ID { get; set; }
        public string MENTOR_GROUP_VISIT_ID { get; set; }
        ...
        public string REGULAR_VISIT { get; set; }
