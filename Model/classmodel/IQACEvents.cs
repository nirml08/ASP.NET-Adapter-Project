...
namespace adapter.Model.classmodel
{
    public class IQACEvents
    {
        ...
        public string ORGANIZERS_ITEM_NAME { get; set; }
        public string COLLABORATION { get; set; }
        public string COLLABORATION_ID { get; set; }
        public string COLLABORATION_ITEM_NAME { get; set; }
        ...
        public string ASSIGNED_FACULTY_NAME { get; set; }
        ...
        public string COLLABORATION_ITEM_ID { get; set; }
        public string EVENT_ORGANIZERS_ITEM_ID { get; set; }
