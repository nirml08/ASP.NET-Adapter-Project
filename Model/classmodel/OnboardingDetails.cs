...
namespace adapter.Model.classmodel
{
    ...
    {
        public string ONBOARDING_ID { get; set; }
        ...
        public string INTERVIEW_STATUS_ID { get; set; }
        public string INTERVIEW_STATUS { get; set; }
        public string OFFER_LETTER_DATE { get; set; }
        public string SALARY { get; set; }
        public string JOINING_DATE { get; set; }
        public string FR_OFFERLETTER_STATUS_ID { get; set; }
        public string FR_OFFERLETTER_STATUS { get; set; }
        public string DOCUMENT_SUBMITTED { get; set; }
        public string ORIENTATION_COMPLETED { get; set; }
        public string APPOINTMENT_LETTER_PATH { get; set; }
